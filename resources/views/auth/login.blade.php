    ...
    <div class="card">
        <div class="card-body login-card-body">
            <div class="login-logo">
                <a href="{{ url('/') }}">
                    <img style="vertical-align: middle; margin-bottom: 15px;" src="{{ asset('/AdminLTE/dist/img/Salsa.png') }}" alt="logo.png" width="65">
                    <p style="font-size: 16px;">Sistem Informasi Inventory Barang</p>
                </a>
            </div>
            <!-- /.login-logo -->
